// lib/syllabus.js(관리자 화면에서만 동적 import 됨)와 components/SyllabusUpload.jsx
// (항상 로드됨) 양쪽이 함께 쓰는 가벼운 순수 함수만 모아 둔다. 여기서 lib/syllabus.js 를
// (역)import 하면 정적 import 경로가 생겨 관리자 전용 코드가 일반 화면 번들로 새어나가므로
// 절대 하지 않는다.
